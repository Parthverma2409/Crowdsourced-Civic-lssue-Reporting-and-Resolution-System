...
export default function Dashboard() {
  ...
  const statCards = [
    { label: "Total Reports", value: stats.total, icon: FileText, accent: "text-slate-600", bg: "bg-slate-100", trend: null },
    { label: "Pending", value: stats.pending, icon: Clock, accent: "text-yellow-600", bg: "bg-yellow-50", trend: null },
    { label: "Assigned", value: stats.assigned, icon: UserCheck, accent: "text-blue-600", bg: "bg-blue-50", trend: null },
    { label: "In Progress", value: stats.inProgress, icon: AlertTriangle, accent: "text-amber-600", bg: "bg-amber-50", trend: null },
    { label: "Resolved", value: stats.resolved, icon: CheckCircle2, accent: "text-emerald-600", bg: "bg-emerald-50", trend: null },
  ];
